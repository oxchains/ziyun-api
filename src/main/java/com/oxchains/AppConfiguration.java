...
import com.oxchains.auth.AuthError;
import com.oxchains.auth.JwtAuthenticationProvider;
import com.oxchains.auth.JwtTokenFilter;
...
public class AppConfiguration extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeRequests()
        .antMatchers(
            "/user/login", "/datav/**","/user/**/downloadfile","/healthz"
        )
        .permitAll()
        .antMatchers("/**/*")
        .authenticated()
