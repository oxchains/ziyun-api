...
public class ProfileConfig {
    ...
    public MonitoringParams activeProfileInfo() throws Exception {
        ...
        final String dbName = getProperty("influxDB.dbName");

        final MonitoringParams monitoringParams = new MonitoringParams(configPath, urlInfluxDB, urlGrafana, dashboardsGrafana, datasourcesGrafana, usernameInfluxDB, passwordInfluxDB, orgPreferencesGrafana, dbName);
