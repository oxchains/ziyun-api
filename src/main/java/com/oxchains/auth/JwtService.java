...
public class JwtService {
  ...
  private final TabUserDao userRepo;

  public JwtService(TabUserDao userRepo) {
  ...
  public String generate(TabUser user) {
  ...
  public Optional<JwtAuthentication> parse(String token) {
    try {
      ...
      TabUser tabUser = userRepo.findByUsername(claims.getSubject());
      if(tabUser != null){
        return Optional.ofNullable(new JwtAuthentication(tabUser, token, claims));
      }
    } catch (Exception e) {
